...
.service('GameManager', function($q, $timeout, GridService, $localStorage) {
  ...
  this.move = function(key) {
    ...
    var f = function() {
        ...
        positions.y.forEach(function(y) {
          ...
          if (tile) {
            ...
            if (next &&
              ...
              if(merged.value >= self.maxWinningValue) {
                  hasMaxWon = true;
                }
      ...
      if (hasWon && !self.win && !self.goForMax) {
        self.win = true;
      }
      
      if (hasMaxWon && !self.maxWin) {
          self.maxWin = true;
        }
